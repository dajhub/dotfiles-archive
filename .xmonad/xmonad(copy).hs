...
myStartupHook = do
    spawnOnce "picom &"
    spawnOnce "setxkbmap -model pc105 -layout gb"
...
myKeys =
        ...
        -- Run Prompt
        , mod' xK_r $ spawn "rofi -show run"
        , modShift xK_p $ spawn "dmenu_run -b -i -nb '#191919' -nf '#c678dd' -sb '#c678dd' -sf '#191919' -fn NotoSansRegular:pixelsize=13"
                -- Commonly used programs
        , mod' xK_Return $ spawn myTerminal
        , mod' xK_b $ spawn myBrowser
        -- Kill Windows
        , mod' xK_w kill1 -- Kills focused window
        , mod' xK_a killAll -- Kills all windows in workspace
               -- Workspaces
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ xmobarPP
              ...
              , ppTitle = xmobarColor "#A1A1A1" "" . shorten 60         -- Title of active window
